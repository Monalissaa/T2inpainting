...
train_need_number = 25
val_number = 500

train_all_path = '/home/mona/codes/lama/datasets/afhq/train_origin/cat'
train_all_names = os.listdir(train_all_path)
print(len(train_all_names))
...
dataset_dir = '/home/mona/codes/lama/datasets/afhq/train/train256_cat/train256_cat_25_random_seed3'
...
# train_all_path = '/home/mona/codes/lama/datasets/MetFace/all-256-except-test'
# train_all_names = os.listdir(train_all_path)
# print(len(train_all_names))
...
# # print(len(train_rest))
# # --- set dir path and create ---
# dataset_dir = '/home/mona/codes/lama/datasets/MetFace/train_100_random_seed2'
# train_need_target_path = os.path.join(dataset_dir, 'train')
# val_500_target_path = os.path.join(dataset_dir, 'val256_cat_500_source')
# val_path = os.path.join(dataset_dir, 'val')
# train_need_txt = os.path.join(dataset_dir, 'train.txt')
...
# # print(len(train_rest))
# # --- set dir path and create ---
# dataset_dir = '/home/mona/codes/lama/datasets/MetFace/train_100_random_seed3'
# train_need_target_path = os.path.join(dataset_dir, 'train')
# val_500_target_path = os.path.join(dataset_dir, 'val256_cat_500_source')
# val_path = os.path.join(dataset_dir, 'val')
# train_need_txt = os.path.join(dataset_dir, 'train.txt')
