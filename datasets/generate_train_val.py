...
train_all_path = '/home/szh/ZYB/lsun/lsun/church_outdoor_all/all-except-test'
train_all_names = os.listdir(train_all_path)
print(len(train_all_names))
...
dataset_dir = '/home/szh/ZYB/lama-under-limited-data/datasets/church/train256_seed3_'+str(train_need_number)
