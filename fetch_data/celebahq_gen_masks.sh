...
python3 bin/gen_mask_dataset.py \
$(pwd)/configs/data_gen/random_thick_256.yaml \
datasets/church/test-2000-source-seed1002-256/ \
datasets/church/test-2000-source-seed1002-256-with-mask/random_thick_256/ \
1002 \
--ext png
...
#python3 bin/gen_mask_dataset.py \
#$(pwd)/configs/data_gen/random_thick_256.yaml \
#datasets/afhq/train/train256_wild/train256_wild_4238/val256_cat_500_source/ \
#datasets/afhq/train/train256_wild/train256_wild_4238/val/random_thick_256/ \
#0
#
#python3 bin/gen_mask_dataset.py \
#$(pwd)/configs/data_gen/random_thin_256.yaml \
#datasets/afhq/train/train256_wild/train256_wild_4238/val256_cat_500_source/ \
#datasets/afhq/train/train256_wild/train256_wild_4238/val/random_thin_256/ \
#0
#
#python3 bin/gen_mask_dataset.py \
#$(pwd)/configs/data_gen/random_medium_256.yaml \
#datasets/afhq/train/train256_wild/train256_wild_4238/val256_cat_500_source/ \
#datasets/afhq/train/train256_wild/train256_wild_4238s/val/random_medium_256/ \
#0
