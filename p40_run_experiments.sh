experiment_name=lama-celebahq_full_config_cat_100_transfer_fsmr3blocks_aug_fix_m_cl2l_cg2l_UD_wo_fm_fsmr_pl
kind=cat
...
echo "go go go" | mail -s "p40-lama-transfer-cat_100_our1_fsmr_pl_loss" 937315849@qq.com
