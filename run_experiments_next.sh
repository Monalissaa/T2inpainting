experiment_name=big-lama-place2_full_config_cat_seed3_wo_fm_tsa_g2g_stage_two_fix_alpha
kind=cat
...
echo "go go go 3090_714_cat_big_lama_tsa_g2g_stage_two_fix_alpha_seed3" | mail -s "3090_714_cat_big_lama_tsa_g2g_stage_two_fix_alpha_seed3!" 937315849@qq.com


# ########################### second


experiment_name=big-lama-place2_full_config_church_seed1_wo_fm_tsa_g2g_stage_two_fix_alpha
kind=church
# create experiments dir
mkdir experiments/$experiment_name
...
# send email to notice
echo "go go go 3090_714_cat_big_lama_tsa_g2g_stage_two_fix_alpha_seed1" | mail -s "3090_714_cat_big_lama_tsa_g2g_stage_two_fix_alpha_seed1!" 937315849@qq.com