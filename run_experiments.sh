# experiment_name=lama-celebahq_full_config_cat_100_transfer_aug_fix_m_cl2l_cg2l_UD_wo_fm_fsmr_downBlocks_third_epoch_only_pl_stage_two_aug_no_fix_wo_fm_fsmr_downBlocks_third_epoch_only_pl
# kind=cat
...
# echo "go go go 3090_714_cat_aug_transfer_our1_fmsr_down_third_epoch_only_pl_our2_fmsr_down_third_epoch_only_pl" | mail -s "3090_714_cat_aug_transfer_our1_fmsr_down_third_epoch_only_pl_our2_f_d_t_only_pl!" 937315849@qq.com


# ########################### second


experiment_name=lama-celebahq_full_config_aug_fix_middleBlocks_convl2l_convg2l_fix_UpDown_without_featureMatching_loss_stage_two_aug_fix_cl2g_cg2g_wo_fm
kind=cat
# create experiments dir
mkdir experiments/$experiment_name
...
# send email to notice
echo "go go go 3090_714_cat_aug_transfer_our2_fix_cl2g_cg2g" | mail -s "3090_714_cat_aug_transfer_our2_fix_cl2g_cg2g!" 937315849@qq.com